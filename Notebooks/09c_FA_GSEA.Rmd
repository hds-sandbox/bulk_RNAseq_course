...
knitr::include_graphics("./img/09c_FA_GSEA/pathway_analysis.png")
``` 
...
```{r, echo = FALSE, eval = TRUE} 
knitr::include_graphics("./img/09c_FA_GSEA/gsea_theory.png")
``` 
...
```{r, echo = FALSE, eval = TRUE} 
knitr::include_graphics("./img/09c_FA_GSEA/gsea_overview.png")
```
...
```
```{r, echo = FALSE, eval = TRUE} 
knitr::include_graphics("./img/09c_FA_GSEA/gsea_kegg_hsa03040.png")
```
...
```{r, echo = FALSE, eval = TRUE} 
knitr::include_graphics("./img/09c_FA_GSEA/hsa03040.pathview.png")
```
