...
knitr::include_graphics("./img/07_exploratory_analysis/deseq_workflow_qc_2018.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/sample_qc.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/rlog_transformation_new.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/example_metadata.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/example_PCA_treatmentPC1.png")
```

We start with the factor `cage`, but the `cage` factor does not seem to explain the variation on PC1 or PC2.

```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/example_PCA_cage.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/example_PCA_sex.png")
```

Next we explore the `strain` factor and find that it explains the variation on PC1. 

```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/example_PCA_strain.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/example_PCA_treatmentPC3.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/heatmap_example.png")
```
...
> **NOTE:** The `rlog()` function can be a bit slow when you have e.g. > 20 samples. In these situations the `vst()` function is much faster and performs a similar transformation appropriate for use with `plotPCA()`. It's typically just a few seconds with `vst()` due to optimizations and the nature of the transformation.
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/PCA_500.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_exploratory_analysis/pheatmap_salmon.png")
```
