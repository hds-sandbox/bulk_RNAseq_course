...
```{r, echo = FALSE, eval = TRUE}
knitr::incllude_graphics("./img/06b_count_normalization/normalization_methods_depth.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::incllude_graphics("./img/06b_count_normalization/normalization_methods_length.png")
```
