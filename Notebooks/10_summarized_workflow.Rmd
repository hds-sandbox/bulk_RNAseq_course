...
meta <- read_table("meta/Mov10_full_meta.txt", skip = 1, col_names = c("samplename","sampletype", "MOVexpr"))
```
...
all(colnames(datacounts)[-1] == metadata$samplename)

# Create DESeq2Dataset object
dds <- DESeqDataSetFromTximport(datacounts[,-1],
                                rowData= datacounts[,1],
                                colData = metadata, 
                                design = ~ condition)
```
