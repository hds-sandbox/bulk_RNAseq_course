...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/08a_contrast_design/metadata.png")
```
...
```
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/08a_contrast_design/contrast_res2.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/08a_contrast_design/contrast_res3.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/08a_contrast_design/contrast_res4.png")
```
