...
knitr::include_graphics("../img/08a_contrast_design/de_theory.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("../img/08a_contrast_design/deseq_workflow1.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("../img/08a_contrast_design/meta_example.png")
```
...
```
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("../img/08a_contrast_design/contrast_res1.png">
```
...
```
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("../img/08a_contrast_design/contrast_res2.png" style="display: block; margin: auto;" />
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("../img/08a_contrast_design/contrast_res3.png" style="display: block; margin: auto;" />
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("../img/08a_contrast_design/contrast_res4.png" style="display: block; margin: auto;" />
```
