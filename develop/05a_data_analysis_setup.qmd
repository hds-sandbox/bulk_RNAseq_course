...
![Job setting using user preprocessing results](./img/05a_data_analysis_setup/jobParams.png)

:::{.callout-note title="Data folders"}
...
:::{.callout-important title="Mount the backup data drive" collapse="true"}
If the data isn't present, you will need to mount the data drive by selecting one of our backup folders that contains the data. Click on `add folder` and then choose `/sandbox_bulkRNAseq(82207)/Intro_to_bulkRNAseq/` 
