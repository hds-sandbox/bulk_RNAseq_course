...
<span style="font-size:30px;"> Exploratory Analysis and Quality Control of bulk RNAseq <span>

The next step in the DESeq2 workflow is QC, which includes sample-level and gene-level steps to perform QC checks on the count data to help us ensure that the samples/replicates look good.

![](./img/06_exploratory_analysis/exploratory_analysis_workflow.png)
...
![](./img/06_exploratory_analysis/sample_qc.png)
...
![Image adapted from "[Beginner's guide to using the DESeq2 package](https://bioc.ism.ac.jp/packages/2.14/bioc/vignettes/DESeq2/inst/doc/beginner.pdf)" by Love, Anders and Huber, 2014](./img/06_exploratory_analysis/rlog_transformation_new.png)
...
![](./img/06_exploratory_analysis/example_metadata.png){width=550px}
...
![](./img/06_exploratory_analysis/example_PCA_treatmentPC1.png){fig-align="center"}

We start with the factor `cage`, but the `cage` factor does not seem to explain the variation on PC1 or PC2.

![](./img/06_exploratory_analysis/example_PCA_cage.png){fig-align="center"}
...
![](./img/06_exploratory_analysis/example_PCA_sex.png){fig-align="center"}

Next we explore the `strain` factor and find that it explains the variation on PC1.

![](./img/06_exploratory_analysis/example_PCA_strain.png){fig-align="center"}
...
![](./img/06_exploratory_analysis/example_PCA_treatmentPC3.png){fig-align="center"}
...
![](./img/06_exploratory_analysis/heatmap_example.png){width=500px fig-align="center"}
...
:::{.callout-warning title="Note on transformed normalized counts"}
...
:::{.callout-note title="Performance of rlog vs vst"}
...
```
![](./img/06_exploratory_analysis/pca_500.png)
...
![](./img/06_exploratory_analysis/pheatmap_salmon.png)
...
display.brewer.all()
```
![](./img/06_exploratory_analysis/rcolor_brewer_all.png){width=600px}
