...
We can see that the `grch38` object already contains all the information we want in a super easy way. Let's annotate the results of our shrunken DEA for Control vs Vampirium:
