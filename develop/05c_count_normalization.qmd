...
<span style="font-size:30px;"> Count normalization with DESeq2 <span>

The first step in the DE analysis workflow is count normalization, which is necessary to make accurate comparisons of gene expression between samples.

![](./img/05c_count_normalization/normalization_workflow.png)
...
![](./img/05c_count_normalization/library_size_bias.png)
...
![](./img/05c_count_normalization/length_bias.png){fig-align="center" width=300px}
...
![](./img/05c_count_normalization/rna_composition_bias.png)
...
:::{.callout-note title="Note on the DESeq2 workflow"}
...
![](./img/05c_count_normalization/deseq_median_of_ratios.png)
