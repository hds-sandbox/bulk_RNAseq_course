...
<span style="font-size:30px;"> Running the nf-core RNAseq pipeline in UCloud <span>
...
![](./img/04c_preprocessing_setup/importParameters2.png){.black-box} 
...
![](./img/04c_preprocessing_setup/importParametersFull.png)
...
![](./img/04c_preprocessing_setup/selectParameters.png)
...
![](img/04c_preprocessing_setup/tmux.png){width=850px}
...
data <- read_csv("./assets/samplesheet.csv",show_col_types = FALSE)

# Print the data as a table, change font size |> tab_options(table.font.size = 13)
data %>% gt() 
```
