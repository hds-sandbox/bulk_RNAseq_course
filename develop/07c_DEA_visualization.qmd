...
<span style="font-size:30px;">Log Fold Shrinkage and DEA visualizations<span>
...
![Illustration taken from the [DESeq2 paper](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-014-0550-8).](./img/07c_DEA_visualization/deseq2_shrunken_lfc.png)
...
![](./img/07c_DEA_visualization/maplot_unshrunken.png)
...
![](./img/07c_DEA_visualization/countPlot.png)
...
![](./img/07c_DEA_visualization/custom_countPlot.png)
...
![](./img/07c_DEA_visualization/sigCont_heatmap.png)
...
![](./img/07c_DEA_visualization/volcano_plot_1.png)
...
![](./img/07c_DEA_visualization/volcano_plot_2.png)
...
```{.r code-overflow-wrap}
res_tableGar_tb <- merge(res_tableGar_tb, tx2gene %>% 
