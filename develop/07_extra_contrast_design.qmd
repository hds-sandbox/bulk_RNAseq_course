...
<span style="font-size:30px;"> Design formula and contrasts<span>
...
![Image credit: Paul Pavlidis, UBC](./img/07_extra_contrast_design/de_theory.png)
...
![](./img/07_extra_contrast_design/deseq_steps.png)
...
![](./img/07_extra_contrast_design/metadata.png)
...
![](./img/07_extra_contrast_design/contrast_res1.png)
...
```
![](./img/07_extra_contrast_design/contrast_res2.png)
...
```
![](./img/07_extra_contrast_design/contrast_res3.png)
...
abline(0, 1, col = "brown", lwd = 2)
```
![](./img/07_extra_contrast_design/contrast_res4.png)
