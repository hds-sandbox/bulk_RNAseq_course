...
<span style="font-size:30px;"> Differential gene expression (DGE) analysis overview <span>
...
![](./img/05b_count_matrix/settingup.png)
...
![](./img/05b_count_matrix/setup2.png)
...
![](./img/05b_count_matrix/setup3.png)
...
:::{.callout-note title="What exactly is the effective length?"}
...
![](./img/05b_count_matrix/deseq_counts_overview.png)
...
![](./img/05b_count_matrix/foldchange_heatmap.png){width=300px}
...
![](./img/05b_count_matrix/de_variation.png)
...
![](./img/05b_count_matrix/de_norm_counts_var.png)
...
:::{.callout-note title="Note on microarray data distribution" collapse="true"}
...
![](./img/05b_count_matrix/deseq_nb.png)

:::{.callout-note title="Note on technical replicates"}
...
:::{.callout-note title="Note on cell lines"}
...
:::{.callout-note title="How do I know if my data should be modeled using the Poisson distribution or Negative Binomial distribution?" collapse="true"}
...
ggplot(df) +
  ...
  scale_x_log10()
```
![](./img/05b_count_matrix/deseq_mean_vs_variance.png)
...
![](./img/05b_count_matrix/seqDepth_DEA.png)
...
![](./img/05b_count_matrix/de_replicates_img.png)
...
![](./img/05b_count_matrix/deg_methods.png)
...
![](./img/05b_count_matrix/DESeq2_workflow.png)
