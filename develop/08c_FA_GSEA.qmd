...
![](./img/08c_FA_GSEA/pathway_analysis.png){fig-align="center"}
...
![](./img/08c_FA_GSEA/gsea_theory.png){fig-align="center"}
...
![Image credit:** [Subramanian et al. Proceedings of the National Academy of Sciences Oct 2005, 102 (43) 15545-15550; DOI: 10.1073/pnas.0506580102](https://www.pnas.org/content/102/43/15545)](./img/08c_FA_GSEA/gsea_overview.png){fig-align="center"}
...
:::{.callout-note title="Other organisms for KEGG pathways"} 
...
```
![](./img/08c_FA_GSEA/gsea_kegg_hsa03040.png){fig-align="center"}
...
pathview(gene.data = foldchanges,
              ...
              cpd = 1))
```
![](./img/08c_FA_GSEA/hsa03040.pathview.png){fig-align="center"}

:::{.callout-tip title="Printing out Pathview images for all significant pathways"}
