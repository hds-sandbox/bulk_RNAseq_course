...
```{r, echo = FALSE, eval = TRUE} 
knitr::include_graphics(paste0("./img/08c_FA_GSEA/gsea_kegg_",gseaKEGG_results$ID[1],".png"))
```
...
```{r, echo = FALSE, eval = TRUE} 
knitr::include_graphics(paste0("./img/08c_FA_GSEA/",gseaKEGG_results$ID[1],".pathview.png"))
```
