...
knitr::include_graphics("./img/07a_DEA/deseq2_workflow_separate.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq2_workflow_separate_sf.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq2_workflow_separate_dis.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq2_mean_vs_variance2.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq_dispersion1.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq2_workflow_separate_fit.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq2_workflow_separate_shr.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq_dispersion2.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/bad_dispersion1.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/bad_dispersion2.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/plotDispersion.png")
```
