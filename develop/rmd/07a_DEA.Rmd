...
knitr::include_graphics("./img/07a_DEA/deseq_steps/Slide1.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq_steps/Slide2.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq_steps/Slide3.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq_mean_vs_variance.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07a_DEA/deseq_steps/Slide4.png")
```
