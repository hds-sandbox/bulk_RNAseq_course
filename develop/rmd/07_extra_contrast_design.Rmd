...
knitr::include_graphics("./img/07_extra_contrast_design/de_theory.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_extra_contrast_design/deseq_workflow1.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_extra_contrast_design/metadata.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_extra_contrast_design/contrast_res1.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_extra_contrast_design/contrast_res2.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_extra_contrast_design/contrast_res3.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07_extra_contrast_design/contrast_res4.png")
```
