...
knitr::include_graphics("./img/07c_DEA_visualization/deseq2_shrunken_lfc.png")
```
...
knitr::include_graphics("./img/07c_DEA_visualization/maplot_unshrunken.png")
knitr::include_graphics("./img/07c_DEA_visualization/MA_plot.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07c_DEA_visualization/topgen_plot.png")
```
...
```{r, echo = FALSE, eval = TRUE, fig.align='left'}
knitr::include_graphics("./img/07c_DEA_visualization/plotCounts_ggrepel.png")
```
...
```{r, echo = FALSE, eval = TRUE, fig.align='left'}
knitr::include_graphics("./img/07c_DEA_visualization/pheatmap_aug2020.png")   
```
...
```{r, echo = FALSE, eval = TRUE, fig.align='left'}
knitr::include_graphics("./img/07c_DEA_visualization/volcano_plot_1.png") 
```
...
```{r, echo = FALSE, eval = TRUE, fig.align='left'}
knitr::include_graphics("./img/07c_DEA_visualization/volcano_plot_2.png") 
```
