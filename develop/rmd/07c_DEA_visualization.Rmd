...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/07c_DEA_visualization/countPlot.png")
```
...
```{r, echo = FALSE, eval = TRUE, fig.align='left'}
knitr::include_graphics("./img/07c_DEA_visualization/custom_countPlot.png")
```
...
```{r, echo = FALSE, eval = TRUE, fig.align='left'}
knitr::include_graphics("./img/07c_DEA_visualization/sigCont_heatmap.png")   
```
