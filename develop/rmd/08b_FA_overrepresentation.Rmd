...
knitr::include_graphics("./img/08b_FA_overrepresentation/pathway_analysis.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/08b_FA_overrepresentation/gene_sets.png")
```
  
```{r, echo = FALSE, eval = TRUE}  
knitr::include_graphics("./img/08b_FA_overrepresentation/overrepresentation_sets.png")
```
...
```{r, echo = FALSE, eval = TRUE}  
knitr::include_graphics("./img/08b_FA_overrepresentation/overrepresentation_tables/Slide2.png")
```
...
```{r, echo = FALSE, eval = TRUE}  
knitr::include_graphics("./img/08b_FA_overrepresentation/overrepresentation_tables/Slide1.png")
```
...
```{r, echo = FALSE, eval = TRUE}  
knitr::include_graphics("./img/08b_FA_overrepresentation/go_heirarchy.jpg")
```
...
```{r, echo = FALSE, eval = TRUE}  
knitr::include_graphics("./img/08b_FA_overrepresentation/cluster_summary.png")
```             
...
```{r, echo = FALSE, eval = TRUE} 
knitr::include_graphics("./img/08b_FA_overrepresentation/cont_vs_vamp_dotplot.png")
``` 
...
```{r, echo = FALSE, eval = TRUE} 
knitr::include_graphics("./img/08b_FA_overrepresentation/emapplot.png")
``` 
...
```{r, echo = FALSE, eval = TRUE} 
knitr::include_graphics("./img/08b_FA_overrepresentation/cnetplot1.png")
``` 
...
!!! tip
    ...
    ```{r, echo = FALSE, eval = TRUE} 
    knitr::include_graphics("./img/08b_FA_overrepresentation/cnetplot-2.png")
    ``` 
