...
knitr::include_graphics("./img/05b_count_matrix/rnaseq_full_workflow.png") #Make new workflow
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/settingup.png") #Make new picture
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/deseq_counts_overview.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/foldchange_heatmap.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/de_variation.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/de_norm_counts_var.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/deseq_nb.png")
```
...
??? note "How do I know if my data should be modeled using the Poisson distribution or Negative Binomial distribution?"
    ...
    ```{r, echo = FALSE, eval = TRUE}
    knitr::include_graphics("./img/05b_count_matrix/deseq_mean_vs_variance.png")
    ```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/seqDepth_DEA.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/de_replicates_img.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/deg_methods1.png")
```

```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/deg_methods2.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05b_count_matrix/deseq_workflow_full_2018.png")
```
