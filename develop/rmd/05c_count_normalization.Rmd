...
knitr::include_graphics("./img/05c_count_normalization/normalization_workflow.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05c_count_normalization/library_size_bias.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05c_count_normalization/rna_composition_bias.png")
```
