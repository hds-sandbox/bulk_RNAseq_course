...
knitr::include_graphics("./img/05c_count_normalization/deseq_workflow_normalization_2018.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05c_count_normalization/normalization_methods_depth.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05c_count_normalization/normalization_methods_length.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05c_count_normalization/normalization_methods_composition.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05c_count_normalization/deseq_median_of_ratios.png")
```
...
```{r, echo = FALSE, eval = TRUE}
knitr::include_graphics("./img/05c_count_normalization/deseq_obj1.png")
```
