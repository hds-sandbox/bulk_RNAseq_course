...
<span style="font-size:30px;"> Automating your workflow: Nextflow and nf-core pipelines <span>
...
![nf-core/rnaseq pipeline metro schematic.](./img/04b_pipelines/nf-core-rnaseq_metro_map_grey.png)
...
![](./img/04b_pipelines/nextflow2014_no-bg.png){width=400px}
...
![](./img/04b_pipelines/nf-core-logo.svg){width=400px}
...
{{< video https://www.youtube.com/watch?v=qMuUt8oVhHw >}}
