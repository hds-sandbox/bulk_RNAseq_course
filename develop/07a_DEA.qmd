...
<span style="font-size:30px;">Gene-level differential expression analysis with DESeq2<span>
...
![](./img/07a_DEA/deseq_steps/Slide1.png)
...
![](./img/07a_DEA/deseq_steps/Slide2.png)
...
![](./img/07a_DEA/deseq_steps/Slide3.png)
...
![](./img/07a_DEA/deseq_mean_vs_variance.png)
...
![](./img/07a_DEA/deseq_dispersion1.png){fig-align="center" width=500px}
...
![](./img/07a_DEA/deseq_steps/Slide4.png)
...
![](./img/07a_DEA/deseq_dispersion2.png){fig-align="center"}
...
![](./img/07a_DEA/bad_dispersion1.png)
...
![](./img/07a_DEA/bad_dispersion2.png)
...
![](./img/07a_DEA/plotDispersion.png){fig-align="center"}
...
![](./img/07a_DEA/exercise_dispersion.png){width=500px}
