...
![Types of experimental replicates. *Image credit: [Klaus B., EMBO J (2015) **34**: 2727-2730](https://dx.doi.org/10.15252%2Fembj.201592958)*](./img/02_experimental_planning/replicates.png){#fig-reps}
...
![*Image credit: [Liu, Y., et al., Bioinformatics (2014) **30**(3): 301--304](https://doi.org/10.1093/bioinformatics/btt688)*](./img/02_experimental_planning/de_replicates_img2.png){#fig-dups} 
...
![](./img/02_experimental_planning/confounded_design.png)
...
![](./img/02_experimental_planning/non_confounded_design.png)
...
- If unable to avoid batches:
    - **Do NOT confound** your experiment by batch (top section in @fig-batch)
- **DO** split replicates of the different sample groups across batches. The more replicates the better, definitely more than 2 (bottom section in @fig-batch).  

![The problem of confounding biological variation and batch effects. *Image credit: [Hicks SC, et al., Biostatistics (2018)](https://doi.org/10.1093/biostatistics/kxx053)*
](./img/02_experimental_planning/batch_effect.png){#fig-batch} 
...
![](./img/02_experimental_planning/metadata_batch.png){fig-align="center" width=400}


:::{.callout-warning title="Warning on sample preparations"} 
