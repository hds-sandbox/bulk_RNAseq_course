...
![](./img/08b_FA_overrepresentation/pathway_analysis.png){fig-align="center"}
...
![](./img/08b_FA_overrepresentation/gene_sets.png)

![](./img/08b_FA_overrepresentation/overrepresentation_sets.png){width=550px fig-align="center"}
...
![](./img/08b_FA_overrepresentation/overrepresentation_tables/Slide2.png){width=550px fig-align="center"}

The calculation of probability of k successes follows the formula:

$$Pr(X = k) = \frac{\binom{K}{k} \binom{N - K}{n-k}}{\binom{N}{n}}$$ 

![](./img/08b_FA_overrepresentation/overrepresentation_tables/Slide1.png){width=550px fig-align="center"}
...
![From Nature Reviews Cancer 7, 23-34 (January 2007)](./img/08b_FA_overrepresentation/go_heirarchy.jpg)
...
data <- read_csv("./assets/clusterProfiler_Cont-Vamp.csv",show_col_types = FALSE)

# Print the data as a table, change font size 
...
![](./img/08b_FA_overrepresentation/cont_vs_vamp_dotplot.png){width=500px}
...
![](./img/08b_FA_overrepresentation/emapplot.png){width=600px fig-align="center"}
...
![](./img/08b_FA_overrepresentation/cnetplot1.png)
...
cnetplot(ego2, 
    ...
    vertex.label.font=6)
```
![](./img/08b_FA_overrepresentation/cnetplot-2.png)
